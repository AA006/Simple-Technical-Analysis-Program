...
while True:
    ...
    # o: rating puanı/ u: Hisse Adı/ y:rating yorumu/ q:low value/ w:high value/
    def file_func(o, u, y, q, w):
    ...
    for i in hisseler:
        ...
        file_func(int(rating * 20), urun.upper(), result_func(int(rating * 20)), data1['low'], data1['high'])
        rating = 0
